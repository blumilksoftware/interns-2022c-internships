  ...
  <div class="w-full h-full">
    ...
    >
      <nav aria-label="Progress" class="cursor-pointer">
        ...
        <button
          @click="setStep(-1)"
          :style="{ visibility: activeStep !== 'info' ? 'visible' : 'hidden' }"
          class="absolute left-14 top-1/2 w-11 h-11 flex justify-center items-center rounded-full shadow-md z-10 bg-gray-100 hover:bg-gray-200 opacity-60 hover:opacity-100"
        >
          <svg
        ...
        <button
          @click="setStep(1)"
          :style="{
            visibility: activeStep !== 'description' ? 'visible' : 'hidden',
          }"
          class="absolute right-14 top-1/2 w-11 h-11 flex justify-center items-center rounded-full shadow-md z-10 bg-gray-100 hover:bg-gray-200 opacity-60 hover:opacity-100"
        >
          <svg
            class="w-8 h-8 font-bold transition duration-500 ease-in-out transform motion-reduce:transform-none text-gray-500 hover:text-gray-600 hover:translate-x-0.5"
            fill="none"
      ...
      <div
        class="w-full h-full flex flex-column items-center justify-center gap-3"
      >
        <div class="flex items-center pt-8 w-full md:w-auto">
          <!-- 1 panel -->
          <section
