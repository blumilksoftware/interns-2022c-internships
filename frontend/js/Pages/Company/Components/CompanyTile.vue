...
<template>
  <div
    class="bg-white overflow-hidden shadow rounded-lg cursor-pointer dark:bg-gray-600"
    @click="onCompanySelect"
  >
    <div class="px-2 py-3 sm:p-2">
      <table>
        <tbody class="divide-y divide-gray-200overflow-hidden py-5">
          <tr>
            <td class="whitespace-nowrap py-4 pl-1 pr-3 text-sm sm:pl-1">
              <div class="flex items-center">
                ...
                <div class="ml-4">
                  <div
                    class="font-medium text-md sm:text-lg max-w-sm text-ellipsis overflow-hidden text-gray-900 dark:text-slate-200"
                  >
                    {{ company.name }}
                  </div>
                  ...
                  >
                    ...
                    <div class="mt-2" v-if="company.has_signed_papers">
                      <span
                        class="bg-green-100 text-green-800 text-xs font-semibold mr-2 px-2.5 py-0.5 rounded dark:bg-emerald-900 dark:text-zinc-200"
                      >
