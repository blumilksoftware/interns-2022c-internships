...
<template>
 <div class="px-4 sm:px-6 lg:px-8 w-full offset-r-0 mt-1 h-7/8  relative overflow-hidden">
    ...
    <div class="mt-4 flex flex-col overflow-hidden h-fit border-2 max-h-full overflow-scroll-y">
      <div class="-my-4 -mx-4 overflow-x-auto h-full overflow-y-auto sm:-mx-6 lg:-mx-8">
          ...
          >
            <table class="min-w-full divide-y table-fixed divide-gray-300">
              <thead class="bg-gray-50">
                <tr>
                  <th scope="col" class=" py-3.5 pl-1 pr-1 text-left text-lg font-semibold text-gray-900 sm:pl-6 w-1/4">First Name</th>
                  <th scope="col" class="py-3.5 pl-1 pr-1 text-left text-lg font-semibold text-gray-900 sm:pl-6 w-1/4">Last name</th>
                  <th scope="col" class="lg:table-cell hidden py-3.5 pr-2 text-left text-lg font-semibold text-gray-900 pl-2 sm:pl-6 w-1/3">E-mail</th>
                  <th scope="col" class="lg:table-cell hidden py-3.5 pl-1 pr-2 text-left text-sm font-semibold text-gray-900 sm:pl-6 w-1/3">Role</th>
            <th scope="col" class="px-3 py-3.5 text-center text-sm font-semibold text-gray-900 lg:table-cell">Companies</th>
              ...
              <tbody class="divide-y divide-gray-200 bg-white">
                <tr v-for="user in props.users" :key="user.id">
                  <td class="whitespace-nowrap py-4 pl-4 pr-3 text-md font-medium text-gray-900 sm:pl-6">
                  ...
                  <td class="whitespace-nowrap py-4 pr-3 text-md font-medium text-gray-900 sm:pl-6 lg:table-cell hidden">
                    <div class="text-left">
                        <div class="text-gray-500">{{ user.email }}</div>
                    </div>
                  </td>
                  <td class="whitespace-nowrap py-4 pl-4 pr-3 text-lg font-medium text-gray-900 sm:pl-6 lg:table-cell hidden">
