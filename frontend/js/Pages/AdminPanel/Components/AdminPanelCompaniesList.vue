  ...
  <div class="px-4 sm:px-6 lg:px-8 w-full offset-r-0 mt-1 h-7/8  relative overflow-hidden">
    <div class="md:flex md:items-center">
      <div class="md:flex-auto">
        <h1 class="text-3xl hidden md:flex justify-center font-semibold text-gray-900">Companies</h1>
      </div>
    </div>
    ...
    <div class="mt-4 flex flex-col overflow-hidden overflow-scroll-y h-fit border-2 max-h-full">
      <div class="-my-4 -mx-4 overflow-x-auto h-full overflow-y-auto sm:-mx-6 lg:-mx-8 ">
        <div class="inline-block min-w-full py-2 align-middle md:px-6 lg:px-8 ">
          ...
          >
            <table class="w-full divide-y table-fixed divide-gray-300 max-h-full">
              <thead class="bg-gray-50">
                <tr>
                  <th scope="col" class="py-3.5 pl-4 pr-1 text-left text-sm font-semibold text-gray-900 sm:pl-6 w-1/3 min-w-md">Name</th>
            <th scope="col" class="hidden px-3 py-3.5 text-left text-sm font-semibold text-gray-900 lg:table-cell w-1/4 min-w-md">City</th>
            <th scope="col" class="hidden px-3 py-3.5 text-left text-sm font-semibold text-gray-900 lg:table-cell w-1/4 min-w-md">E-Mail</th>
            <th scope="col" class="hidden px-3 py-3.5 text-center text-sm font-semibold text-gray-900 lg:table-cell w-1/4 min-w-md">Status</th>
            <th scope="col" class="relative py-3.5 pl-3 pr-4 sm:pr-6 w-1/6">
              ...
              <tbody class="divide-y divide-gray-200 bg-white max-h-full">
                <tr v-for="company in props.companies" :key="company.id">
                  ...
                  <td class="hidden whitespace-nowrap px-3 py-4 text-sm text-gray-500 lg:table-cell">
                    <div class="text-gray-600">{{ company.contact_details.email }}</div>
                  </td>
                  <td class="hidden whitespace-nowrap px-3 py-4 text-center text-3xl text-gray-500 lg:table-cell">
