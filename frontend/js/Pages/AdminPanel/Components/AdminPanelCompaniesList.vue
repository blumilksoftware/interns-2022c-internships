...
<template>
  <div class="px-4 sm:px-6 lg:px-8 w-4/5 offset-r-0 mt-1 h-full overflow-hidden">
      ...
      <div class="-my-4 -mx-4 overflow-x-auto sm:-mx-6 lg:-mx-8">
        <div class="inline-block min-w-full py-2 align-middle md:px-6 lg:px-8">
          ...
          >
            ...
            <th scope="col" class="hidden px-3 py-3.5 text-left text-sm font-semibold text-gray-900 lg:table-cell">City</th>
