...
<template>
    <div class="xl:m-auto my-10 mx-8 max-w-4xl px-0 sm:px-0 border-1 border-gray-700 shadow-md rounded-lg bg-white w-full lg:px-8">
      ...
      <li v-for="company in companies" :key="company.name" class=" flex  rounded-md shadow-sm my-3 cursor-pointer">
        ...
        <div class="flex flex-1 items-center justify-between truncate rounded-r-md border-t border-r border-b border-gray-200 bg-white">
          <div class="flex-1 truncate px-4 py-2 text-md">
            ...
            <p class="text-gray-500">{{ company.quantity }} Companies</p>
          </div>
        </div>
      </li>
    </ul>
  ...
  <script setup>
    ...
    const companies = [
      { name: 'Actives ', href: '#', quantity: 8, bgColor: 'bg-green-500' },
      { name: 'Changed ', href: '#', quantity: 1, bgColor: 'bg-blue-500' },
      { name: 'New', href: '#', quantity: 3, bgColor: 'bg-yellow-500' },
