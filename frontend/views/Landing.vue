          ...
          >
            <div class="sm:text-center lg:text-left">
              ...
              <p
                ...
                "
              >
                Wybierz wydział na którym studiujesz i znajdź wymarzonych
                praktykodawców.
              </p>
              <div
      ...
      >
        ...
        >
          ...
          <p class="mt-6 text-lg text-left text-gray-500">
            ...
            odpowiedniego praktykodawcy. Jest to projekt open source - każdy
            może skorzystać w pełni za darmo.
          </p>
          <router-link
            to="/home"
            tag="button"
